...
| 技術 | バージョン | 用途 |
|------|-----------|------|
| Next.js | 16.2.10 | フレームワーク（App Router） |
...
| 技術 | バージョン | 用途 |
|------|-----------|------|
| @xyflow/react | 12.11.1 | グラフ描画・インタラクション |

### コード解析

| 技術 | バージョン | 用途 |
|------|-----------|------|
| @babel/parser | 8.0+ | コードパース（JSX/TSX対応） |
| @babel/traverse | 8.0+ | AST走査 |
| @babel/types | 8.0+ | AST型定義 |

### ユーティリティ

| 技術 | バージョン | 用途 |
|------|-----------|------|
| lodash | 4.18+ | ユーティリティ関数 |

### 開発・テスト

| 技術 | バージョン | 用途 |
|------|-----------|------|
| Vitest | 4.1.9 | テストランナー |
| @testing-library/react | 16.3+ | コンポーネントテスト |
| @vitest/coverage-v8 | 4.1.9 | カバレッジ計測 |
| ESLint | 10.6+ | リンター |
| Prettier | 3.9+ | フォーマッター |
